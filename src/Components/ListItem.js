    ...
    return (
        <div className="show-items container mt-3">
            ...
            <div className="reset text-center d-flex " >
                ...
                <button type="reset" className={`btn-danger m-auto items-remove-all ${!propItems.showfav ? 'd-block' : propItems.items.some((val) => val.fav === true) ? 'd-block' : 'd-none'}`} onClick={propItems.eraseAll}>Erase All</button>
            </div>
        </div>
    )
}
